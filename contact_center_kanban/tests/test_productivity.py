            ...
            .create(
                {
                    ...
                    "body_sha256": "fixture",
                    "scheduled_at": future,
                    # ORM timestamps may include microseconds; make this
                    # synthetic orphan eligible for the second-precision cutoff.
                    "write_date": fields.Datetime.now() - datetime.timedelta(seconds=2),
                }
            )
        )
