...
class TestSourceWebhookLink(SavepointCase):
    ...
    def test_ui_exposes_source_only_to_system_administrators(self):
        ...
        self.assertTrue(
            system_api.bootstrap()["capabilities"]["view_technical_message"]
        )
        self.assertFalse(
            cc_admin_api.bootstrap()["capabilities"]["view_technical_message"]
        )
        self.assertTrue(
            system_api.bootstrap()["capabilities"]["view_technical_channel"]
        )
        self.assertFalse(
            cc_admin_api.bootstrap()["capabilities"]["view_technical_channel"]
        )
